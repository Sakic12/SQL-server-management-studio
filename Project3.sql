...
GO
/*2.
 U Vašoj bazi podataka kreirati tabele sa sljedeæim parametrima:
- Studenti
...
/*3.
Kreirati tabelu Predmeti sa sljedeæim parametrima:
...
Modifikovati tabelu Nastava (ukloniti kolonu Predmet) i povezati je sa tabelom Predmeti. Koristeæi INSERT
...
/*4.
Koristeæi bazu podataka AdventureWorksLT2012 i tabelu SalesLT.Customer, preko INSERT i SELECT komande
importovati 10 zapisa u tabelu Studenti i to sljedeæe kolone:
...
GO
/*5.
U Vašoj bazi podataka kreirajte stored proceduru koja æe na osnovu proslijeðenih parametara raditi izmjenu
(UPDATE) podataka u tabeli Studenti. Proceduru pohranite pod nazivom usp_Studenti_Update. Koristeæi
...
GO
/*6.
U Vašoj bazi podataka kreirajte stored proceduru koja æe raditi INSERT podataka u tabelu Nastava. Podaci se
moraju unijeti preko parametara. Takoðer, u istoj proceduri dodati prisustvo na nastavi (koristeæi INSERT
...
/*7.
Koristeæi proceduru koju ste kreirali u prethodnom zadatku dodati novu nastavu. Za parametar @Datum
proslijediti trenutni datum i vrijeme, a ostale parametre upisati ruèno
*/
...
/*8.
U Vašoj bazi podataka kreirajte stored proceduru koja æa na osnovu proslijeðenih parametara (@NastavaID i
...
GO
/*9.
U Vašoj bazi podataka kreirajte view koji æe sadržavati sljedeæa polja: broj dosijea, ime i prezime studenta,
datum nastave, uèionicu, nastavnika i predmet. View pohranite pod nazivom view_Studenti_Nastava.
*/
