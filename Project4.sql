/*1.
Kreirati bazu podataka koju æete imenovati Vašim brojem dosijea. Fajlove baze smjestiti na sljedeæe lokacije:
...
- Opis, polje za unos dužeg niza karaktera.
Napomena: Klijent može uzeti više kredita, dok se kredit veže iskljuèivo za jednog klijenta. Svaki kredit može imati
...
/*3.
Koristeæi AdventureWorks2014 bazu podataka, imporTOvati 10 kupaca u tabelu Klijenti i TO sljedeæe kolONe:
...
g. 'FIT' -> Kompanija
Takoðer, u tabelu Krediti unijeti mINimalno tri zapisa sa proizvoljnim podacima
*/
...
/*5.
Kreirati view (pogled) nad podacima koji æe prikazivati sljedeæa polja: jmbg, ime i prezime, adresa, telefon i
email klijenta, zatim datum, namjenu i iznos kredita, te ukupan broj otplaæenih rata i ukupan otplaæeni iznos.
...
/*6.
Kreirati sTOred proceduru koja æe na osnovu proslijeðenog parametra @JMBG prikazivati podatke o otplati
...
GO
/*7.
. Kreirati proceduru koja æe služiti za izmjenu podataka o otplati kredita. Proceduru pohraniti pod nazivom
...
GO
/*8.
Kreirati sTOred proceduru koja æe služiti za brisanje kredita zajedno sa svim otplatama. Proceduru pohranite
...
/*9.
Kreirati TRIGGER koji æe sprijeèiti brisanje zapisa u tabeli Otplate. TRIGGER pohranite pod nazivom
